...
public class StampTimeWalkPath {
    ...
    @Procedure(name = "edge2Time.StampTimeWalkPath", mode = Mode.READ)
    public Stream<Result> testTransaction(@Name("Path") Path p,
        ...
        log.info("Total number of time-respecting paths found: " + paths.size());
...
//            return thEdge;
        ...
        Map<String, List<List<Double>>> ap = st.myStamp(ts1, ts2, (int) window, r);
