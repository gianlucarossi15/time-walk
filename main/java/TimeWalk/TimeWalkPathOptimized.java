...
public class TimeWalkPathOptimized {
    ...
    @Procedure(name = "edge2Time.TimeWalkPathOpt", mode = Mode.READ)
...
//        TD_JOIN t = new TD_JOIN();
        ...
        Map<String, List<List<Double>>> ap = t.TD_Join(ts1, ts2, window, r, threshold);
