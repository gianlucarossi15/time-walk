...
### Data generation
 - The **FinBench** datasets were obtained from the official repository:  
   [https://drive.google.com/drive/folders/1NIAo4KptskBytbXoOqmF3Sto4hTX3JIH](https://drive.google.com/drive/folders/1NIAo4KptskBytbXoOqmF3Sto4hTX3JIH) made available by LDBC council itself.
    Experiments were conducted using the following scaling factors: **0.1**, **0.3**, **1.0** and **3.0**. Each dataset has been enriched with the balance time series for the Account node type, 1000, 5000, 10000, and 100000 time series respectively.
 ...
 - The **Synthea** datasets were obtained from the official repository:  
   ...
   For each patient we collected the heart rate, body weight, body height, respiratory rate, BMI from the Observations.csv file, generated by the Synthea generator.
